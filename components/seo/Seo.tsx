...
export const generateSeoMetadata = ({
    ...
    description =
      'I am an A-Grade licensed electrician and full-stack developer based in Melbourne, providing electrical services alongside custom web and WordPress development.',
