...
export const ROOM_GLB = {
  ...
  sofa: '/models/learning-room/real/sofa-modern.glb?v=1',
  coffeeTable: '/models/learning-room/polyhaven/modern_coffee_table_01/modern_coffee_table_01_1k.gltf?v=1',
  television: '/models/learning-room/real/tv-samsung.glb?v=1',
  tvCabinet: '/models/learning-room/real/tv-byas.glb?v=1',
